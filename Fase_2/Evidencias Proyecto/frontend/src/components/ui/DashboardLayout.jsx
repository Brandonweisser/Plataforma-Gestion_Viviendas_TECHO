...
export function DashboardLayout({ title, subtitle, user, onLogout, children, accent = 'blue', footer }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-techo-blue-50/40 via-white to-white dark:from-techo-gray-900 dark:via-techo-gray-900 dark:to-techo-gray-900 transition-colors">
